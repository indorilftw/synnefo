...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'ProjectMembership.request_date'
        db.delete_column('im_projectmembership', 'request_date')

        # Deleting field 'ProjectMembership.leave_request_date'
        db.delete_column('im_projectmembership', 'leave_request_date')

        # Deleting field 'ProjectMembership.acceptance_date'
        db.delete_column('im_projectmembership', 'acceptance_date')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'ProjectMembership.request_date'
        db.add_column('im_projectmembership', 'request_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 7, 10, 14, 42, 22, 741523), blank=True), keep_default=False)

        # Adding field 'ProjectMembership.leave_request_date'
        db.add_column('im_projectmembership', 'leave_request_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'ProjectMembership.acceptance_date'
        db.add_column('im_projectmembership', 'acceptance_date', self.gf('django.db.models.fields.DateTimeField')(null=True, db_index=True), keep_default=False)
