...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Network.mode'
        db.add_column('db_network', 'mode', self.gf('django.db.models.fields.CharField')(max_length=16, null=True), keep_default=False)

        # Adding field 'Network.tags'
        db.add_column('db_network', 'tags', self.gf('django.db.models.fields.CharField')(max_length=128, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Network.mode'
        db.delete_column('db_network', 'mode')

        # Deleting field 'Network.tags'
        db.delete_column('db_network', 'tags')
