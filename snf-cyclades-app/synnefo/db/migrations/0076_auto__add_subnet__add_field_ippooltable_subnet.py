...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Subnet'
        db.create_table('db_subnet', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('network', self.gf('django.db.models.fields.related.ForeignKey')(related_name='subnets', to=orm['db.Network'])),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('ipversion', self.gf('django.db.models.fields.IntegerField')(default=4)),
            ('cidr', self.gf('django.db.models.fields.CharField')(max_length=64, null=True)),
        ...
        # Adding field 'IPPoolTable.subnet'
        db.add_column('db_ippooltable', 'subnet',
