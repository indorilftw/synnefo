...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'IPAddress.project'
        db.add_column('db_ipaddress', 'project',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'VirtualMachine.project'
        db.add_column('db_virtualmachine', 'project',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)

        # Adding field 'Network.project'
        db.add_column('db_network', 'project',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VirtualMachine.project'
        db.delete_column('db_virtualmachine', 'project')
