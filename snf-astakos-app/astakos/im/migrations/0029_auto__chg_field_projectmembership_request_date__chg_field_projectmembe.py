...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ProjectMembership.leave_request_date'
        db.alter_column('im_projectmembership', 'leave_request_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProjectMembership.acceptance_date'
        db.alter_column('im_projectmembership', 'acceptance_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'ProjectMembership.leave_request_date'
        db.alter_column('im_projectmembership', 'leave_request_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'ProjectMembership.acceptance_date'
        db.alter_column('im_projectmembership', 'acceptance_date', self.gf('django.db.models.fields.DateField')(null=True))
