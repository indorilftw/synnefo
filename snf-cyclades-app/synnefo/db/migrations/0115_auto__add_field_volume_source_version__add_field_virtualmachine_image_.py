...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Volume.source_version'
        db.add_column('db_volume', 'source_version',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)

        # Adding field 'VirtualMachine.image_version'
        db.add_column('db_virtualmachine', 'image_version',
                      self.gf('django.db.models.fields.IntegerField')(null=True),
                      keep_default=False)
