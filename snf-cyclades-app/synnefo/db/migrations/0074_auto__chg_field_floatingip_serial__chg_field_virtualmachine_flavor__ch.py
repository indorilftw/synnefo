...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FloatingIP.serial'
        db.alter_column('db_floatingip', 'serial_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['db.QuotaHolderSerial']))

        # Changing field 'VirtualMachine.flavor'
        db.alter_column('db_virtualmachine', 'flavor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['db.Flavor'], on_delete=models.PROTECT))

        # Changing field 'VirtualMachine.backend'
        db.alter_column('db_virtualmachine', 'backend_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.PROTECT, to=orm['db.Backend']))

        # Changing field 'VirtualMachine.serial'
        db.alter_column('db_virtualmachine', 'serial_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['db.QuotaHolderSerial']))

        # Changing field 'Network.serial'
        db.alter_column('db_network', 'serial_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, on_delete=models.SET_NULL, to=orm['db.QuotaHolderSerial']))

        # Changing field 'BackendNetwork.backend'
        db.alter_column('db_backendnetwork', 'backend_id', self.gf('django.db.models.fields.related.ForeignKey')(on_delete=models.PROTECT, to=orm['db.Backend']))

    def backwards(self, orm):

        # Changing field 'FloatingIP.serial'
        db.alter_column('db_floatingip', 'serial_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['db.QuotaHolderSerial']))

        # Changing field 'VirtualMachine.flavor'
        db.alter_column('db_virtualmachine', 'flavor_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['db.Flavor']))

        # Changing field 'VirtualMachine.backend'
        db.alter_column('db_virtualmachine', 'backend_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['db.Backend']))

        # Changing field 'VirtualMachine.serial'
        db.alter_column('db_virtualmachine', 'serial_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['db.QuotaHolderSerial']))

        # Changing field 'Network.serial'
        db.alter_column('db_network', 'serial_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['db.QuotaHolderSerial']))

        # Changing field 'BackendNetwork.backend'
        db.alter_column('db_backendnetwork', 'backend_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['db.Backend']))
