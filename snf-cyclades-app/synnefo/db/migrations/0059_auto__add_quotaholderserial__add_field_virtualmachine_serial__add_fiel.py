...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('db_quotaholderserial', (
            ...
            ('pending', self.gf('django.db.models.fields.BooleanField')(default=True, db_index=True, blank=True)),
            ('accepted', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
            ('rejected', self.gf('django.db.models.fields.BooleanField')(default=False, blank=True)),
        ))
        db.send_create_signal('db', ['QuotaHolderSerial'])

        # Adding field 'VirtualMachine.serial'
        db.add_column('db_virtualmachine', 'serial', self.gf('django.db.models.fields.related.ForeignKey')(related_name='virtual_machine', null=True, to=orm['db.QuotaHolderSerial']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'VirtualMachine.serial'
        db.delete_column('db_virtualmachine', 'serial_id')
