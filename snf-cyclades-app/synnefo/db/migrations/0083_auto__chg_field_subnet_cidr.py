...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Subnet.cidr'
        db.alter_column('db_subnet', 'cidr', self.gf('django.db.models.fields.CharField')(default='10.0.0.0/24', max_length=64))

    def backwards(self, orm):

        # Changing field 'Subnet.cidr'
        db.alter_column('db_subnet', 'cidr', self.gf('django.db.models.fields.CharField')(max_length=64, null=True))
    ...
    models = {
        ...
        'db.ippooltable': {
            ...
            'reserved_map': ('django.db.models.fields.TextField', [], {'default': "''"}),
            'size': ('django.db.models.fields.IntegerField', [], {}),
            'subnet': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'ip_pool'", 'null': 'True', 'to': "orm['db.Subnet']"})
        },
