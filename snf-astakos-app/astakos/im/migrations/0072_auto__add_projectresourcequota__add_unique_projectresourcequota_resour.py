...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('im_projectresourcequota', (
            ...
            ('project_capacity', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
            ('member_capacity', self.gf('django.db.models.fields.BigIntegerField')(default=0)),
        ))
        db.send_create_signal('im', ['ProjectResourceQuota'])

        # Adding unique constraint on 'ProjectResourceQuota', fields ['resource', 'project']
        db.create_unique('im_projectresourcequota', ['resource_id', 'project_id'])

        # Changing field 'ProjectApplication.member_join_policy'
        db.alter_column('im_projectapplication', 'member_join_policy', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'ProjectApplication.private'
        db.alter_column('im_projectapplication', 'private', self.gf('django.db.models.fields.NullBooleanField')(null=True))

        # Changing field 'ProjectApplication.owner'
        db.alter_column('im_projectapplication', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['im.AstakosUser']))

        # Changing field 'ProjectApplication.end_date'
        db.alter_column('im_projectapplication', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'ProjectApplication.name'
        db.alter_column('im_projectapplication', 'name', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))

        # Changing field 'ProjectApplication.member_leave_policy'
        db.alter_column('im_projectapplication', 'member_leave_policy', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Adding field 'Project.last_application'
        db.add_column('im_project', 'last_application', self.gf('django.db.models.fields.related.ForeignKey')(related_name='last_of_project', null=True, to=orm['im.ProjectApplication']), keep_default=False)

        # Adding field 'Project.owner'
        db.add_column('im_project', 'owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name='projs_owned', null=True, to=orm['im.AstakosUser']), keep_default=False)

        # Adding field 'Project.realname'
        db.add_column('im_project', 'realname', self.gf('django.db.models.fields.CharField')(max_length=80, null=True), keep_default=False)

        # Adding field 'Project.homepage'
        db.add_column('im_project', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=255, null=True), keep_default=False)

        # Adding field 'Project.description'
        db.add_column('im_project', 'description', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'Project.end_date'
        db.add_column('im_project', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True), keep_default=False)

        # Adding field 'Project.member_join_policy'
        db.add_column('im_project', 'member_join_policy', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Project.member_leave_policy'
        db.add_column('im_project', 'member_leave_policy', self.gf('django.db.models.fields.IntegerField')(null=True), keep_default=False)

        # Adding field 'Project.limit_on_members_number'
        db.add_column('im_project', 'limit_on_members_number', self.gf('django.db.models.fields.BigIntegerField')(null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ProjectResourceQuota'
        db.delete_table('im_projectresourcequota')

        # Changing field 'ProjectApplication.member_join_policy'
        db.alter_column('im_projectapplication', 'member_join_policy', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'ProjectApplication.private'
        db.alter_column('im_projectapplication', 'private', self.gf('django.db.models.fields.BooleanField')())

        # Changing field 'ProjectApplication.owner'
        db.alter_column('im_projectapplication', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['im.AstakosUser']))

        # Changing field 'ProjectApplication.end_date'
        db.alter_column('im_projectapplication', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'ProjectApplication.name'
        db.alter_column('im_projectapplication', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=80))

        # Changing field 'ProjectApplication.member_leave_policy'
        db.alter_column('im_projectapplication', 'member_leave_policy', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Deleting field 'Project.last_application'
        db.delete_column('im_project', 'last_application_id')

        # Deleting field 'Project.owner'
        db.delete_column('im_project', 'owner_id')

        # Deleting field 'Project.realname'
        db.delete_column('im_project', 'realname')

        # Deleting field 'Project.homepage'
        db.delete_column('im_project', 'homepage')

        # Deleting field 'Project.description'
        db.delete_column('im_project', 'description')

        # Deleting field 'Project.end_date'
        db.delete_column('im_project', 'end_date')

        # Deleting field 'Project.member_join_policy'
        db.delete_column('im_project', 'member_join_policy')

        # Deleting field 'Project.member_leave_policy'
        db.delete_column('im_project', 'member_leave_policy')

        # Deleting field 'Project.limit_on_members_number'
        db.delete_column('im_project', 'limit_on_members_number')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 10, 58, 54, 330483)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 10, 58, 54, 330431)'}),
        ...
        'im.project': {
            ...
            'realname': ('django.db.models.fields.CharField', [], {'max_length': '80', 'null': 'True'}),
