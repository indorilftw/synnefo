...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'EndpointData'
        db.create_table('im_endpointdata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('endpoint', self.gf('django.db.models.fields.related.ForeignKey')(related_name='data', to=orm['im.Endpoint'])),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=1024)),
        ))
        db.send_create_signal('im', ['EndpointData'])

        # Adding unique constraint on 'EndpointData', fields ['endpoint', 'key']
        db.create_unique('im_endpointdata', ['endpoint_id', 'key'])

        # Adding model 'Service'
        db.create_table('im_service', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('component', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['im.Component'])),
        ...
        db.create_table('im_endpoint', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('service', self.gf('django.db.models.fields.related.ForeignKey')(related_name='endpoints', to=orm['im.Service'])),
        ))
        db.send_create_signal('im', ['Endpoint'])

    def backwards(self, orm):

        # Removing unique constraint on 'EndpointData', fields ['endpoint', 'key']
        db.delete_unique('im_endpointdata', ['endpoint_id', 'key'])

        # Deleting model 'EndpointData'
        db.delete_table('im_endpointdata')

        # Deleting model 'Service'
        db.delete_table('im_service')

        # Deleting model 'Endpoint'
        db.delete_table('im_endpoint')
