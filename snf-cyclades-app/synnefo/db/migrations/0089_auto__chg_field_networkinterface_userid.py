...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'NetworkInterface.userid'
        db.alter_column('db_networkinterface', 'userid', self.gf('django.db.models.fields.CharField')(default='', max_length=128))

    def backwards(self, orm):

        # Changing field 'NetworkInterface.userid'
        db.alter_column('db_networkinterface', 'userid', self.gf('django.db.models.fields.CharField')(max_length=128, null=True))
