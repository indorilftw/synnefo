...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Volume', fields ['project']
        db.create_index('db_volume', ['project'])

        # Adding index on 'IPAddress', fields ['project']
        db.create_index('db_ipaddress', ['project'])

        # Adding index on 'VirtualMachine', fields ['project']
        db.create_index('db_virtualmachine', ['project'])
    ...
    def backwards(self, orm):
        ...
        # Removing index on 'VirtualMachine', fields ['project']
        db.delete_index('db_virtualmachine', ['project'])

        # Removing index on 'IPAddress', fields ['project']
        db.delete_index('db_ipaddress', ['project'])
