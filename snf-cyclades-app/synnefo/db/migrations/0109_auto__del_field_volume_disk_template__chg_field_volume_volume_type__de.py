...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.delete_unique('db_flavor', ['disk', 'ram', 'cpu', 'volume_type_id'])

        # Adding field 'Volume.disk_template'
        db.add_column('db_volume', 'disk_template',
        ...
        db.add_column('db_flavor', 'disk_template',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=32),
                      keep_default=False)
