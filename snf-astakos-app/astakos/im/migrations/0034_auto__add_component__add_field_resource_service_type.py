...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('im', ['Component'])

        # Adding field 'Resource.service_type'
        db.add_column('im_resource', 'service_type', self.gf('django.db.models.fields.CharField')(default='', max_length=255), keep_default=False)

    def backwards(self, orm):

        # Deleting model 'Component'
        db.delete_table('im_component')

        # Deleting field 'Resource.service_type'
        db.delete_column('im_resource', 'service_type')
