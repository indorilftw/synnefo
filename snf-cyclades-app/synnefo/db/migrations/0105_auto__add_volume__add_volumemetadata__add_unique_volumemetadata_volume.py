...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('db_volume', (
            ...
            ('userid', self.gf('django.db.models.fields.CharField')(max_length=100, db_index=True)),
            ('size', self.gf('django.db.models.fields.IntegerField')()),
            ('disk_template', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('delete_on_termination', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('source', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('origin', self.gf('django.db.models.fields.CharField')(max_length=128, null=True)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(default='CREATING', max_length=64)),
            ('snapshot_counter', self.gf('django.db.models.fields.PositiveIntegerField')(default=0)),
            ('machine', self.gf('django.db.models.fields.related.ForeignKey')(related_name='volumes', null=True, to=orm['db.VirtualMachine'])),
        ...
        db.send_create_signal('db', ['Volume'])

        # Adding model 'VolumeMetadata'
        db.create_table('db_volumemetadata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('key', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('value', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('volume', self.gf('django.db.models.fields.related.ForeignKey')(related_name='metadata', to=orm['db.Volume'])),
        ))
        db.send_create_signal('db', ['VolumeMetadata'])
