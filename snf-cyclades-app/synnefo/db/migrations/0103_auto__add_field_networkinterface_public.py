...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'NetworkInterface.public'
        db.add_column('db_networkinterface', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'NetworkInterface.public'
        db.delete_column('db_networkinterface', 'public')
