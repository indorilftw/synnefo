...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('db_image', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ...
            ('mapfile', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('os', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('osfamily', self.gf('django.db.models.fields.CharField')(max_length=256)),
        ))
