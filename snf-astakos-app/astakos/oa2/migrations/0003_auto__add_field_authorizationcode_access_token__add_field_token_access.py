...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AuthorizationCode.access_token'
        db.add_column('oa2_authorizationcode', 'access_token',
                      self.gf('django.db.models.fields.CharField')(default='online', max_length=100),
                      keep_default=False)

        # Adding field 'Token.access_token'
        db.add_column('oa2_token', 'access_token',
                      self.gf('django.db.models.fields.CharField')(default='online', max_length=100),
                      keep_default=False)
    ...
    models = {
        ...
        'oa2.authorizationcode': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 28, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
