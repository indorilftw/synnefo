...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for resource in resources:
            if resource.uplimit == MAX:
                resource.project_default = MAX
                resource.save()
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 28, 11, 56, 39, 999402)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 28, 11, 56, 39, 999350)'}),
