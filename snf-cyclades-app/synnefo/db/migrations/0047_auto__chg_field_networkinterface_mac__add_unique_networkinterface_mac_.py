...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'NetworkInterface', fields ['mac']
        db.create_unique('db_networkinterface', ['mac'])

        # Adding field 'Backend.index'
    ...
    def backwards(self, orm):
        ...
        # Removing unique constraint on 'NetworkInterface', fields ['mac']
        db.delete_unique('db_networkinterface', ['mac'])

        # Deleting field 'Backend.index'
        db.delete_column('db_backend', 'index')
