...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('db_volumetype', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('disk_template', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('deleted', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('db', ['VolumeType'])

        # Adding field 'Volume.volume_type'
        db.add_column('db_volume', 'volume_type',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='volumes', null=True, on_delete=models.PROTECT, to=orm['db.VolumeType']),
                      keep_default=False)

        # Adding field 'Flavor.volume_type'
        db.add_column('db_flavor', 'volume_type',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Volume.volume_type'
        db.delete_column('db_volume', 'volume_type_id')
    ...
    models = {
        ...
        'db.flavor': {
            ...
            'volume_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'flavors'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['db.VolumeType']"})
        },
        'db.ipaddress': {
        ...
        'db.volume': {
            ...
            'updated': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'userid': ('django.db.models.fields.CharField', [], {'max_length': '100', 'db_index': 'True'}),
            'volume_type': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'volumes'", 'null': 'True', 'on_delete': 'models.PROTECT', 'to': "orm['db.VolumeType']"})
        },
        'db.volumemetadata': {
