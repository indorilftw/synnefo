...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'VirtualMachine.imageid'
        db.add_column('db_virtualmachine', 'imageid', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'VirtualMachine.imageid'
        db.delete_column('db_virtualmachine', 'imageid')
    ...
    models = {
        ...
        'db.virtualmachine': {
            ...
            'charged': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 12, 7, 11, 34, 42, 699331)'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'flavor': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['db.Flavor']"}),
