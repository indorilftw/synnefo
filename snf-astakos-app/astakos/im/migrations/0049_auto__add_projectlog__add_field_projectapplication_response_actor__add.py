...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('im_projectlog', (
            ...
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(related_name='log', to=orm['im.Project'])),
            ('from_state', self.gf('django.db.models.fields.IntegerField')(null=True)),
            ('to_state', self.gf('django.db.models.fields.IntegerField')()),
            ('date', self.gf('django.db.models.fields.DateTimeField')()),
            ('actor', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['im.AstakosUser'], null=True)),
            ('reason', self.gf('django.db.models.fields.TextField')(null=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True)),
        ))
        db.send_create_signal('im', ['ProjectLog'])

        # Adding field 'ProjectApplication.response_actor'
        db.add_column('im_projectapplication', 'response_actor', self.gf('django.db.models.fields.related.ForeignKey')(related_name='responded_apps', null=True, to=orm['im.AstakosUser']), keep_default=False)

        # Adding field 'ProjectApplication.waive_date'
        db.add_column('im_projectapplication', 'waive_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)

        # Adding field 'ProjectApplication.waive_reason'
        db.add_column('im_projectapplication', 'waive_reason', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ProjectApplication.response_actor'
        db.delete_column('im_projectapplication', 'response_actor_id')

        # Deleting field 'ProjectApplication.waive_date'
        db.delete_column('im_projectapplication', 'waive_date')

        # Deleting field 'ProjectApplication.waive_reason'
        db.delete_column('im_projectapplication', 'waive_reason')
