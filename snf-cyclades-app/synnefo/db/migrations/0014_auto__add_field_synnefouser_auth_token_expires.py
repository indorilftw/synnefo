...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('db_synnefouser', 'tmp_auth_token_expires', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, null=True, blank=True), keep_default=False)

    def backwards(self, orm):

        # Deleting field 'SynnefoUser.tmp_auth_token'
        db.delete_column('db_synnefouser', 'tmp_auth_token')

        # Deleting field 'SynnefoUser.tmp_auth_token_expires'
        db.delete_column('db_synnefouser', 'tmp_auth_token_expires')
    ...
    models = {
        ...
        'db.virtualmachine': {
            ...
            'charged': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 6, 14, 12, 39, 12, 450303)'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
