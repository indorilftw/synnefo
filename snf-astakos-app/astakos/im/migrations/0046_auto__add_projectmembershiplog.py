...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ProjectMembershipLog'
        db.create_table('im_projectmembershiplog', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('membership', self.gf('django.db.models.fields.related.ForeignKey')(related_name='log', to=orm['im.ProjectMembership'])),
        ...
        db.send_create_signal('im', ['ProjectMembershipLog'])

    def backwards(self, orm):

        # Deleting model 'ProjectMembershipLog'
        db.delete_table('im_projectmembershiplog')
