...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.uuid'
        db.alter_column('im_project', 'uuid', self.gf('django.db.models.fields.CharField')(default=None, unique=True, max_length=255))

    def backwards(self, orm):

        # Changing field 'Project.uuid'
        db.alter_column('im_project', 'uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=255, null=True))
