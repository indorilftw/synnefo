...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IPAddress.ipversion'
        db.alter_column('db_ipaddress', 'ipversion', self.gf('django.db.models.fields.IntegerField')(default=4))

    def backwards(self, orm):

        # Changing field 'IPAddress.ipversion'
        db.alter_column('db_ipaddress', 'ipversion', self.gf('django.db.models.fields.IntegerField')(null=True))
