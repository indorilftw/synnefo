...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Project.limit_on_members_number'
        db.alter_column('im_project', 'limit_on_members_number', self.gf('django.db.models.fields.BigIntegerField')(default=0))

        # Changing field 'Project.member_join_policy'
        db.alter_column('im_project', 'member_join_policy', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Project.end_date'
        db.alter_column('im_project', 'end_date', self.gf('django.db.models.fields.DateTimeField')(default=None))

        # Changing field 'Project.member_leave_policy'
        db.alter_column('im_project', 'member_leave_policy', self.gf('django.db.models.fields.IntegerField')(default=0))

        # Changing field 'Project.homepage'
        db.alter_column('im_project', 'homepage', self.gf('django.db.models.fields.URLField')(default='', max_length=255))

        # Changing field 'Project.realname'
        db.alter_column('im_project', 'realname', self.gf('django.db.models.fields.CharField')(default='', max_length=80))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Project.limit_on_members_number'
        db.alter_column('im_project', 'limit_on_members_number', self.gf('django.db.models.fields.BigIntegerField')(null=True))

        # Changing field 'Project.member_join_policy'
        db.alter_column('im_project', 'member_join_policy', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.end_date'
        db.alter_column('im_project', 'end_date', self.gf('django.db.models.fields.DateTimeField')(null=True))

        # Changing field 'Project.member_leave_policy'
        db.alter_column('im_project', 'member_leave_policy', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Project.homepage'
        db.alter_column('im_project', 'homepage', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

        # Changing field 'Project.realname'
        db.alter_column('im_project', 'realname', self.gf('django.db.models.fields.CharField')(max_length=80, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 15, 56, 16, 309692)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 12, 12, 15, 56, 16, 309559)'}),
