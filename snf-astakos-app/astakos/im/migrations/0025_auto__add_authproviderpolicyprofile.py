...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('im_authproviderpolicyprofile', (
            ...
            ('is_exclusive', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('policy_add', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('policy_remove', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('policy_create', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('policy_login', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('policy_limit', self.gf('django.db.models.fields.IntegerField')(default=None, null=True)),
            ('policy_required', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('policy_automoderate', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
            ('policy_switch', self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True)),
        ...
        db.create_table('im_authproviderpolicyprofile_groups', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authproviderpolicyprofile', models.ForeignKey(orm['im.authproviderpolicyprofile'], null=False)),
            ('group', models.ForeignKey(orm['auth.group'], null=False))
        ))
        db.create_unique('im_authproviderpolicyprofile_groups', ['authproviderpolicyprofile_id', 'group_id'])

        # Adding M2M table for field users on 'AuthProviderPolicyProfile'
        db.create_table('im_authproviderpolicyprofile_users', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('authproviderpolicyprofile', models.ForeignKey(orm['im.authproviderpolicyprofile'], null=False)),
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field groups on 'AuthProviderPolicyProfile'
        db.delete_table('im_authproviderpolicyprofile_groups')
